...
test('contact subject is stored as the label the visitor saw', function () {
    $contact = Contact::factory()->create(['subject' => 'Proje Teklifi']);

    expect($contact->fresh()->subject)->toBe('Proje Teklifi');
});
