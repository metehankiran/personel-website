...
--}}
@if($light && $dark)
    <img data-site-logo="light" src="{{ $light }}" alt="" class="{{ $logoClass }} w-auto object-contain shrink-0 dark:hidden" />
    <img data-site-logo="dark" src="{{ $dark }}" alt="" class="{{ $logoClass }} w-auto object-contain shrink-0 hidden dark:block" />
@elseif($light || $dark)
    <img data-site-logo src="{{ $light ?? $dark }}" alt="" class="{{ $logoClass }} w-auto object-contain shrink-0" />
@else
